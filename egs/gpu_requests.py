...
def request_gpu(
    ...
    enable_auto_gpu_auto_selection: bool = False,
    ...
    prefered_cluster: Optional[List[str]] = None,
    ...
    req = CreateGprRequest(
        ...
        prefered_cluster=prefered_cluster,
        enable_auto_cluster_selection=enable_auto_cluster_selection,
        enable_auto_gpu_selection=enable_auto_gpu_auto_selection,
