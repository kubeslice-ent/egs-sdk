...
if __name__ == "__main__":
    ...
    parser.add_argument("--request_name",
                        required=True,
                        help="Name of the GPU request")
    parser.add_argument("--cluster_name",
                        required=True,
                        help="Name of the Cluster")
    parser.add_argument("--workspace_name",
                        required=True,
                        help="Name of workspace_name")
    parser.add_argument("--priority",
                        required=True,
                        type=int,
                        help="The priority of the request.")
    parser.add_argument("--exit_duration",
                        required=True,
    ...
    try:
        ...
        if workspace_and_cluster_exists(workspaces,
            ...
            if args.gpu_shape:
                ...
                matching_items = [
                    workspace for workspace in inventory.workspace_inventory if workspace.gpu_shape == args.gpu_shape
                ]
                if len(matching_items):
                    cur_inventory = matching_items[0]

            gpu_request_id = egs.request_gpu(request_name=args.request_name,
            ...
            print(f'Workspace {args.workspace_name} doesnot exists in {args.cluster_name} cluster')
